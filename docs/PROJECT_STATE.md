...
аккаунта (скрейп профиля + расшифровка или OCR кадров его роликов). Сценарий
собирается из карточки фактов: продукт + 4 кадра + шаблон суфлёра. LLM пишет
только нишу, столпы и аудит.
...
- YouTube-скрейпинг нет: онбординг и анализ честно отказывают, а не рисуют демо.
- Живых ключей скрейпа/AI/YooKassa в этой среде нет — end-to-end на настоящем
  аккаунте в этом ране не гонялся. Харнесс и API закрывают путь «красивая ложь».
