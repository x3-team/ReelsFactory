...
**Черновик / не для демо заказчику как live:** остальные 10 из корпуса 16;
YouTube; Agency-клиенты без своих ссылок; Студия (ремейк/автопсия);
пакет площадок как обещание кросспоста; ЮKassa без реквизитов.
Первая пачка из 6 прогнана live (4 скрейпа + 2 честных YouTube 400).
...
- Первая пачка (6) прогнана 15.08.2026: `APIFY_TOKEN` был, `AITUNNEL_API_KEY`
  не было. 4 live-скрейпа + 2 YouTube 400. Остальные 10 не гоняли.
