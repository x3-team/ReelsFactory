          ...
          <ol className="mt-10 space-y-8">
            {[
              ...
              },
              {
                ...
                d: "15 / 30 / 45 секунд. Открыл суфлёр с камерой — читаешь и снимаешь на одном телефоне.",
              },
            ].map((step) => (
              <li
                key={step.n}
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <ul className="mt-10 space-y-5 text-[1.05rem] leading-7 text-white/88">
            {[
              ...
              "Суфлёр с камерой: читаешь текст и снимаешь на одном телефоне",
              "Текст поста и сценарий — копируй в один тап",
            ].map((item) => (
      ...
      <section className="border-t border-border/60 bg-background px-5 py-16 md:px-8 md:py-20">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-3 max-w-[44ch] text-[1.05rem] leading-7 text-muted-foreground">
            Всё на одном телефоне: камера и текст сценария на одном экране.
          </p>
          <ol className="mt-10 space-y-8">
            {[
              {
                n: "01",
                t: "Открой «Снимать здесь»",
                d: "Включаем фронтальную камеру. Сценарий полупрозрачно едет по экрану — его видишь только ты.",
              },
              {
                n: "02",
                t: "Жми «Запись» и говори",
                d: "Скорость текста можно замедлить. Смотришь в камеру и читаешь строки — как с телесуфлёром.",
              },
              {
                n: "03",
                t: "Сохрани и выложи в Reels",
                d: "Ролик сохраняется на телефон — отправляешь в Instagram / TikTok. Отдельный второй телефон не нужен.",
              },
            ].map((step) => (
              <li
                key={step.n}
